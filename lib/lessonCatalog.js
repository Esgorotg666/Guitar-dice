...
var UNITS = [
  ...
  { id: 'fingering', title: 'Fingering techniques', blurb: 'Independence, spiders, crossovers.', test: /spider|hand-|cross|stretch/, capstone: 'cap-fingering', minLevel: 'entry' },
  ...
  { id: 'legato', title: 'Hammer-ons, pull-offs, slides', blurb: 'Legato that connects boxes.', test: /lead-pent|lead-slide|lead-legato|lead-fifth/, capstone: 'cap-legato', minLevel: 'entry' },
  { id: 'rhythm', title: 'Rhythm skills', blurb: 'Palm mute, chuck, boom-chick, 16ths.', test: /rhy-pm|rhy-funk|rhy-country|rhy-folk|ac-2/, capstone: 'cap-rhythm', minLevel: 'entry' },
  { id: 'lead', title: 'Lead guitar skills', blurb: 'Alternate picking, bends, vibrato.', test: /lead-alt|lead-bend|vib|lead-rh-/, capstone: 'cap-lead', minLevel: 'entry' },
  ...
  { id: 'arpeggio', title: 'Arpeggios and rolls', blurb: 'Broken chords that follow the change.', test: /am-roll|aed|roll-aed|lead-a7|lead-cmaj|arpeg/, capstone: 'cap-arpeggio', minLevel: 'intermediate' },
  ...
  { id: 'rh', title: 'Right hand', blurb: 'Pick stroke, i-m, inside and outside.', test: /lead-rh-|ac-im-|ac-finger/, capstone: 'cap-lead', minLevel: 'entry' }
];
