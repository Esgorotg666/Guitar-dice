...
import { defaultTypedSlots, normaliseFace } from './diceFaces';

const DEVICES = [
  { id:'secondary-dominant', label:'V7 setup', offset:7, suffix:'7',
    why: function (t) { return 'The V7 of ' + t + '. It pulls hard into the next chord.'; } },
  { id:'tritone-sub', label:'Tritone sub', offset:1, suffix:'7',
    why: function (t) { return 'A half step above ' + t + '. Same tension as the V7.'; } },
  { id:'dim-approach', label:'Diminished approach', offset:-1, suffix:'dim7',
    why: function (t) { return 'Walks up into ' + t + ' by a half step.'; } },
  { id:'ii-chord', label:'ii before the V', offset:2, suffix:'m7',
    why: function (t) { return 'The ii of ' + t + '.'; } },
  { id:'chromatic-slide', label:'Chromatic slide', offset:1, suffix:'m7',
    why: function (t) { return 'Slides down a half step into ' + t + '.'; } },
  { id:'backdoor', label:'Backdoor approach', offset:-2, suffix:'7',
    why: function (t) { return 'Comes at ' + t + ' from a whole step below.'; } }
];
...
export function sanitiseSlots(slots) {
  return (slots || []).map(function (s) { return normaliseFace(s); });
}
