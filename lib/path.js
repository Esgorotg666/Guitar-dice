...
export const PATHS = {
  lead: chain('lead', [
    ...
    { id: 'master-alt-dom-c', skill: 'G7alt into Cmaj7' },
    { id: 'master-outside-am', skill: 'Outside then inside over Am' },
    { id: 'master-trit-am', skill: 'ii half-dim subV i' },
    { id: 'master-neo-aharm', skill: 'A harmonic minor three rooms' },
    { id: 'master-sweep-am', skill: 'Am sweep then a line' }
  ]),
  rhythm: chain('rhythm', [
    { id: 'rhy-pm-1', skill: 'Palm-muted power chords' },
    { id: 'study-gallop', skill: 'Palm-mute gallop workshop' },
    ...
    { id: 'master-drop2-gcd', skill: 'Drop-2 G C D' },
    { id: 'master-thump-e', skill: 'Thump and pop on E7' },
    { id: 'master-quartal-d', skill: 'Quartal plane from D' },
    { id: 'master-78-e', skill: 'Seven-eight riff in E' },
    { id: 'master-harm-gallop', skill: 'E harmonic minor gallop + answer' }
  ]),
