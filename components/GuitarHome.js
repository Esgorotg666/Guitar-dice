  ...
  return (
    <Shell genre={genre} theme={resolvedTheme(appSettings.theme)}>
      ...
      <header className="appHead">
        ...
        <div>
          <h1>Guitar Dice</h1>
          <p className="muted sm">{styleMeta.label} - {genreLabel} - {guitarTitle(locker)}</p>
        </div>
        <div className="stats">
        ...
        <div>
          ...
          {!sel && scale ? (
            <div className="card">
              ...
              <Fretboard guitar={locker.guitar} root={scale.root} mode={scale.mode} showNotes={showNotes}
