export const DEFAULT_CODES = [
  { code: 'DICEWEEK', tier: 'extreme', days: 7, max: 12, label: 'Launch week' },
  { code: 'FRIEND1', tier: 'extreme', days: 7, max: 1, label: 'Friend pass 1' },
  { code: 'FRIEND2', tier: 'extreme', days: 7, max: 1, label: 'Friend pass 2' },
  { code: 'FRIEND3', tier: 'extreme', days: 7, max: 1, label: 'Friend pass 3' }
];
...
export function allPromoCodes() {
  ...
  const seen = {};
  const out = [];
  env.concat(DEFAULT_CODES).forEach(function (c) {
