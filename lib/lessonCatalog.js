...
var UNITS = [
  ...
  { id: 'harmony', title: 'Advanced harmony', blurb: 'Interchange, planing, and voice leading.', test: /borrow|b6-b7|plane-|guide-251|pivot-camg|chrom-approach|chrom-cliche/ },
...
var UNIT_PLANS = {
  ...
  harmony: {
    minutes: 12,
    bpm: 76,
    startId: 'rhy-borrow-iv7',
    blocks: [
      '4 min — I-iv-bVII-I in C. Full shapes. Ab and Bb must show up.',
      '4 min — Guide tones on ii-V-I, or the C-Am-F-G pivot. Common tones stay.',
      '4 min — Either planing rail or chromatic approach. One tool, not all four.'
    ],
    stop: 'If beat 1 is a random scale tone, you are not leading or borrowing. Fix the landing.'
  },
  changes: {
    minutes: 12,
    bpm: 76,
