...
var UNITS = [
  ...
  { id: 'flamenco', title: 'Flamenco palos', blurb: 'Compás, por medio / por arriba, tangos to siguiriya.', test: /^fla-|flamenco|palo|solea|buler|alegri|siguiri|tangos|fandango|sevillanas/, capstone: 'cap-flamenco', minLevel: 'entry' },
...
var UNIT_PLANS = {
  ...
  flamenco: {
    ...
    startId: 'fla-clap-12',
    blocks: [
      'Clap the grid first. 4-count vs 12-count.',
      'Entry: tangos and sevillanas. Intermediate: soleá, alegrías, fandango.',
      'Master: falseta + cierre, bulerías from 12, siguiriya accent flip.',
      'Finale only after the drills at that level are clean.'
    ],
    stop: 'If beat 10 is late, stop the cycle.'
  }
};
